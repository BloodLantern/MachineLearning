...
namespace MachineLearning.MonoGame;
...
public static class ImGuiUtils
{
    ...
    extension (ImGui)
    {
        public static void GridPlotting(string label, ref Vector2 value) => ImGui.GridPlotting(label, ref value, -1f, 1f);
        ...
        public static void DisplayNeuralNetwork(NeuralNetwork.NeuralNetwork network) => ImGui.DisplayNeuralNetwork(network, new(600f, 600f));
        ...
        public static unsafe bool SliderDouble(string label, ref double v, double v_min, double v_max)
            => ImGui.SliderScalar(label, ImGuiDataType.Double, (nint) Unsafe.AsPointer(ref v), (nint) Unsafe.AsPointer(in v_min), (nint) Unsafe.AsPointer(in v_max));
    }
}
